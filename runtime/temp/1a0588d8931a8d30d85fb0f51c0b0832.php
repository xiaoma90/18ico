...
<!--                             <li class="">
            ...
            <div class="user-body-right">
                <div id="notify_wrap">
                    <div class="notify-hd">
                        <span class="msg-time">主题</span>
                        <span class="msg-time">时间</span>
                        <span class="msg-time">简略</span>
                        <span class="msg-time">查看</span>
                    </div>
                    <div class="notify-bd">
                        <ul class="msg-list">
                        <?php if(!empty($notice)): foreach($notice as $v): ?>
<li>
    <span class="msg-time"><?php echo $v['title']; ?></span>
    <span class="msg-time"><?php echo date('Y-m-d H:i',($v['created_at'])); ?></span>
    <span class="msg-time"><?php echo $v['remark']; ?></span>
    <span class="msg-time"><a onClick='see("<?php echo $v['id']; ?>")'>点击查看</a></span>
    <div style="display: none" id="pp<?php echo $v['id']; ?>"><?php echo $v['content']; ?></div>
</li>
                        <?php endforeach; endif; ?>
                        </ul>
                        <div id="notify-footer">
                            <div class="notify-page-info">
                                <span><?php echo $num; ?>条记录&nbsp;&nbsp;1/1页，</span>
                            </div>
                            <div id="notify_page">
                                <div id="notify_pagination"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="http://18ico.ewtouch.com/static/admin/js/plugins/layer/skin/layer.css"></script>
<script type="text/javascript">
    function see(id){
        ...
        // layer.msg($('#pp'+id).text());
        $(".layui-layer-close1").text('X')
    }
</script>
<!-- <script src="__JS__/vendor-140c67b313.bundle.js"></script> -->
<!-- <script src="__JS__/app-d2b0299975.bundle.js"></script> -->
