<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/18ico.ewtouch.com/public/../application/home/view/view/token.html";i:1504944843;s:79:"/www/wwwroot/18ico.ewtouch.com/public/../application/home/view/view/header.html";i:1504766399;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <title>
...
<div id="user_content">
        ...
        <div class="banner-bg">s
            <div class="banner-center clearfix">
                ...
                <div class="head-right">
                    ...
                    <div id="security_rate" class="account-security" data-factor="25">
                    </div>
                    <div class="authentication sprite-item auth-bg">
                        <div class="identity-auth">
                            <i></i>
                            <span>实名认证：</span>
                            <a href="identity.html" class="goto-auth">立即认证</a>
                        </div>
                        <div class="email-auth">
                            <i></i>
                            <span>电子邮箱：</span>
                            <a href="personal.html" class="goto-auth">立即绑定</a>
                        </div>
                        <div class="phone-auth">
                            <i></i>
                            <span>手机号码：</span>
                            <a href="personal.html">177*****013</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="user-container">
        <div class="user-body">
            <div class="user-left-menu">
                <div class="mod-side-nav">
                    <div class="inner">
                        ...
                        <ul class="tab-menu-list">
                            <li class="current">
                                <a href="my_count.html" class="li-grid">账户总览
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                                <a href="personal.html" class="li-grid">个人信息
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                                <a href="identity.html" class="li-grid">实名认证
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                                <a href="security.html" class="li-grid">安全设置
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                ...
                <div class="mod-side-nav">
                    <div class="inner">
                        ...
                        <ul class="tab-menu-list">
                            <li class="">
                                <a href="support.html" class="li-grid">我支持的项目
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                                <a href="project.html" class="li-grid">我发起的项目
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                            ...
                            <li class="">
                                <a href="favorite.html" class="li-grid">我关注的项目
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                        </ul>
                ...
                <div class="mod-side-nav">
                    <div class="inner">
                        ...
                        <ul class="tab-menu-list">
                            <li class="">
                                <a href="capital.html" class="li-grid">资金明细
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                                <a href="recharge.html" class="li-grid">资金充值
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                            <li class="">
                                <a href="withdrawal.html" class="li-grid">资金提现
                                </a>
                                <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477"><path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>
                            </li>
                        </ul>
            ...
            <div class="user-body-right token-body-page">
                <div id="token-wrap">
                    <div class="back">
                        <a href="personal.html" class="backhref">
                            <svg class="svg-icon" height="12" width="12" viewBox="0 0 19 9.477">

                                <path class="arrow-down" fill-rule="evenodd" clip-rule="evenodd" fill="#272536" d="M1.92 0H0l9.522 9.477L19 0h-2.024L9.508 7.364 1.92 0z"></path></svg>返回</a>
                    </div>
                    <div class="account">
                        <span class="token-account">账户余额：<span class="money"></span><span class="equivalent">（折合CNY）</span></span>
                    </div>
                    <div class="token-body">
                        <table class="table">
                            <thead>
                            <tr>
                                <th class="first">币种</th>
                                <th class="second">类型</th>
                                <th>数量</th>
                                <th class="fourth">金额&nbsp;(￥)</th>
                                <th class="last">操作</th>
                            </tr>
                            </thead>
                            <tbody class="token-tbody"><tr><td class="currency">BTC</td><td class="second">比特币</td><td>0.00</td><td class="fourth">0.00</td><td class="last"><a href="recharge.html" class="recharge">充值</a><a href="withdrawal.html" class="withdraw">提现</a></td></tr><tr><td class="currency">ETH</td><td class="second">以太坊</td><td>0.00</td><td class="fourth">0.00</td><td class="last"><a href="recharge.html" class="recharge">充值</a><a href="withdrawal.html" class="withdraw">提现</a></td></tr></tbody>
                        </table>
                        <div class="token-footer">
                            <div class="page-count"><span>0记录 </span><span>1/1页</span></div>
                            <div id="token_page"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<footer>
    <div class="footer-wrapper">
        <div class="about-us-w">
            <img src="__IMG__/bottom_logo.png" class="bottom_logo"/>
        </div>
