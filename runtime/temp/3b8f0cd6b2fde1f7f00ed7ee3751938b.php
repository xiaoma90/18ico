<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/18ico.ewtouch.com/public/../application/admin/view/auth/person.html";i:1505201528;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        ...
                        <!-- <th data-field="local_name">本地姓名</th> -->
...
<!--         <tr>
        ...
        <tr>
            <td>生日：</td>
            <td class="auth_birthday"></td>
        </tr> 
        <tr>
            <td>手持身份证正面：</td>
            <td><img class="auth_hand_front" style="max-height:75px;" src="__IMG__/a1.jpg"></td>
        </tr>
        <tr>
            <td>身份证正面：</td>
            <td><img class="auth_front" style="max-height:75px;" src="__IMG__/a1.jpg"></td>
        </tr>
        <tr>
            <td>身份证背面：</td>
            <td><img class="auth_back" style="max-height:75px;" src="__IMG__/a1.jpg"></td>
        </tr>
        <tr>
            <td>拒绝原因：</td>
...
<script type="text/javascript">
    ...
    function auth_detail(id){
        $.getJSON("<?php echo url('auth/auth_detail'); ?>", {'id' : id}, function(res){
            $('.auth_phone').text(res.phone);
            $('.auth_name').text(res.name);
            // $('.auth_local_name').text(res.local_name);
            ...
            $('.auth_birthday').text(res.birthday);
            $('.auth_hand_front').attr('src',res.hand_front);
            $('.auth_hand_front').attr('style','width:300px;height:300px;');
            $('.auth_front').attr('src',res.front);
            $('.auth_front').attr('style','width:300px;height:300px;');
            $('.auth_back').attr('src',res.back);
            $('.auth_back').attr('style','width:300px;height:300px;');
    ...
    function authedit(id){
        layer.confirm('您是否批准实名此认证？', {
            ...
            $.getJSON("<?php echo url('auth/authEdit'); ?>", {'id' : id,'status':3}, function(res){
            ...
            layer.prompt({title: '请输入拒绝原因', formType: 2}, function(text, index){
                $.getJSON("<?php echo url('auth/authEdit'); ?>", {'id' : id,'status':2,'resaon':text}, function(res){
                    layer.close(index);
