...
<!--                             <li class="">
            ...
            <div class="user-body-right">
                <div class="identity-page-right" id="identity_wrap">
                    ...
                    <?php else: ?>
                        <button type="button" class="identity-switch-item person-identity" data-type="person">个人认证</button>
                        <button type="button" class="identity-switch-item agency-identity active" data-type="agency">机构认证</button>
                    <?php endif; ?>    
                    </div>
                    <div class="person-identity-toggle identity-form">
                        <form action="#" id="person_identity_form">
                            ...
                            <div class="china-person">
                                ...
                                <input type="text" name="name" value="<?php echo !empty($data['name'])?$data['name']:null; ?>" >
                                </div>
                                <div class="form-group">
                                    <label for="idcard">身份证号码：</label>
                                    <input type="text" name="card_id" value="<?php echo !empty($data['card_id'])?$data['card_id']:null; ?>" >
                                </div>
                                <div class="form-group m30">
                                    ...
                                    <div class="upload-identity">
                                        <a href="javascript:" class="upload-file-button upload-id-front">
                                            ...
                                            <img src="<?php echo !empty($data['hand_front'])?$data['hand_front']:null; ?>" name="imgurl1"  onclick="javascript:$('#fmimg1').click();" />
                                        </a>
                                        <p>手持身份证正面</p>
                                    </div>
                                ...
                                <div class="form-group m30">
                                    ...
                                    <div class="upload-identity">
                                        <a href="javascript:" class="upload-file-button upload-id-front">
                                           <input type="hidden" value="<?php echo !empty($data['front'])?$data['front']:null; ?>" name="front" > 
                                          
                                           
                                            <img src="<?php echo !empty($data['front'])?$data['front']:null; ?>"  name="imgurl2"  onclick="javascript:$('#fmimg2').click();" />
                                        </a>
                                        <p>身份证正面</p>
                                    </div>
                                    <div class="upload-example">
                                    ...
                                    <div class="upload-identity">
                                        <a href="javascript:" class="upload-file-button upload-id-front">
                                           <input type="hidden"  name="back" > 
                                            ...
                                            <img src="<?php echo !empty($data['back'])?$data['back']:null; ?>"  name="imgurl3"  onclick="javascript:$('#fmimg3').click();" />
                                        </a>
                                        <p>身份证背面</p>
                                    </div>
                                    <div class="upload-example">
                            ...
                            <div class="foreign-person hide">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo !empty($data['name'])?$data['name']:null; ?>"  name="name1" >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group m30">
                                    ...
                                    <div class="upload-identity">
                                        <a href="javascript:" class="upload-file-button upload-id-front">
                                           <input type="hidden" name="hand_front1" > 
                                           
                                            <img src="__IMG__/fly_add.png"  name="imgurl4"  onclick="javascript:$('#fmimg4').click();" />
                                        </a>
                                        <p>请上传护照图片</p>
                                    </div>
                                ...
                                <div class="form-group m30">
                                    ...
                                    <div class="upload-identity">
                                        <a href="javascript:" class="upload-file-button upload-id-front">
                                           <input type="hidden" name="front1" > 
                                           
                                            <img src="__IMG__/fly_add.png"  name="imgurl5"  onclick="javascript:$('#fmimg5').click();" />
                                        </a>
                                        <p>请上传护照图片</p>
                                    </div>
                                    <div class="passport-upload-example">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="days"  placeholder="日">
                                </div>
                                <div class="form-group">
                                    <label>当前居住国家：</label>
                                     <div class="country-select"> 
                        ...
                        <form action="#" id="agency_identity_form">
                            <div class="form-group">
                               ...
                               <div class="country-select"> 
                                    <select name="state" class="fly_select">
                                        <option value="<?php echo !empty($data['state'])?$data['state']:null; ?>"><?php echo !empty($data['state'])?$data['state']:null; ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="china-identity">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo !empty($data['company'])?$data['company']:null; ?>" name="company" >
                                </div>
                                <div class="form-group">
                                    <label for="register_num">企业注册号：</label>
                                    <input type="text" value="<?php echo !empty($data['register_num'])?$data['register_num']:null; ?>" name="register_num"  >
                                </div>
                                <div class="form-group">
                                    <label for="legal_person">法人代表姓名：</label>
                                    <input type="text" value="<?php echo !empty($data['legal_person'])?$data['legal_person']:null; ?>" name="legal_person" >
                                </div>
                                <div class="form-group">
                                    <label for="register_year">注册日期：</label>
                                    <input type="text" value="<?php echo !empty($data['register_time'])?$data['register_time']:null; ?>"  name="register_year" placeholder="年">

                                </div>
                                <div class="form-group">
                                    <label for="register_address">注册地址：</label>
                                    <input type="text" value="<?php echo !empty($data['register_address'])?$data['register_address']:null; ?>" name="register_address" >
                                </div>
                                <div class="form-group m30">
                                    ...
                                    <div class="upload-identity">
                                        <a href="javascript:" class="upload-file-button upload-id-front">
                                           <input type="hidden" name="license" > 
                                            ...
                                            <img src="<?php echo !empty($data['license'])?$data['license']:null; ?>"  name="imgurl6"  onclick="javascript:$('#fmimg6').click();" />
                                        </a>
                                        <p>企业营业执照</p>
                                    </div>
                                </div>
                            ...
                            <div class="foreign-identity hide">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_foreign_name" >
                                </div>
                                <div class="form-group">
                                    <label for="company_local_name">公司名称(本地语言)：</label>
                                    <input type="text" name="company_local_name" >
                                </div>
                                <div class="form-group">
                                    <label for="register_code">企业注册号：</label>
                                    <input type="text" name="register_num1" >
                                </div>
                                <div class="form-group">
                                    <label for="for_register_year">注册日期：</label>
                                    <input type="text" name="register_year1"  placeholder="年">
                                    <input type="text" name="register_month1"  placeholder="月">
                                    <input type="text" name="register_day1"  placeholder="日">
                                </div>
                                <div class="form-group">
                                    <label></label>
