                    ...
                    <div class="project-body">
                        <table class="table">
                            ...
                            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <td class="text-center"><?php echo $vo['ico_days']; ?></td>
                                <td class="text-center"><?php echo $vo['created_at']; ?></td>
                                <td class="text-center">                               
                                    <?php switch($vo['is_do']): case "1": ?>预收<?php break; case "2": ?>进行中<?php break; case "3": ?>已完成<?php break; case "4": ?>失败<?php break; endswitch; ?>
                                </td>
...
<!--                             <div class="page-count"><span>0条记录 </span><span>1/1页</span></div>
                            <div id="project_page" class="project-pager"></div> -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            success:function(data){
                ...
                if ( num > 0 ) {
                    ...
                    for (var i = 0; i < num; i++) {
                        ...
                        option+='<tr>';
                        option+='<td class="text-center">'+vo[i]['name']+'</td>';
                        option+='<td class="text-center">';
                        option+='<div>ETH:'+vo[i]['eth_target']+'</div>';
                        option+='<div>BTC:'+vo[i]['btc_target']+'</div>';
                        option+='<div>LTC:'+vo[i]['ltc_target']+'</div>';
                        option+='</td>';
                        option+='<td class="text-center">'+vo[i]['ico_days']+'</td>';
