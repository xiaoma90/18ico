<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/18ico.ewtouch.com/public/../application/admin/view/news/newsadd.html";i:1504926427;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="auther" type="text" value="18ICO" class="form-control" name="auther" required="" aria-required="true" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-2">
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <option value="2">18ico</option>
                                    <option value="3">关于18ico</option>
                                    <option value="4">条款和协议</option>
                                    <option value="5">常见问题</option>
                                    <option value="6">我想发起众筹...</option>
                                    <option value="7">站内通知</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <textarea id="remark" type="text" class="form-control" name="remark" required="" aria-required="true"></textarea>
                            </div>
                        </div>
