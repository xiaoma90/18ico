            ...
            <div class="user-body-right">
                <div id="favorite_wrap">
                    <div class="favorite-header">
                        <h3>我关注的项目</h3>
                        <span class="header-right">还有更多的项目等着您来关注 <!-- <a href="/items" target="_blank" class="contact-service">查看更多</a> --></span>
                    </div>
                    <div class="favorite-body">
                        <!-- <p class="text-center empty-favorite">暂无关注项目哦~</p> -->
                        <?php foreach($data as $vo): ?>
                        <div class="section" style="height: 386px">
                            <div class="block-left">
                                <a href="/home/project/finish/id/<?php echo $vo['id']; ?>" class="pro-pic"><img src="<?php echo $vo['l_banner']; ?>" alt=""></a>
                            </div>
                            <div class="block-right">
                                <a href="javascript:;" class="del-state" data-item="<?php echo $vo['id']; ?>" style="font-size: 18px;">X</a>
                                <div class="block-title">
                                <h4><a href="javascript:;"><?php echo $vo['name']; ?></a></h4>
                                <p><?php echo $vo['remark']; ?></p>
                                <div class="raise-funds">
                                    <div class="raise-money">
                                    <a class="raise-already btc-font-family raise-completed">ETH&nbsp;<?php echo !empty($vo['eth_ed'])?$vo['eth_ed']:0; ?></a><span class="raise-text"> 已筹金额</span>
                                    </div>
                                    ...
                                    <a class="progress-percent raise-completed "><?php echo $vo['naa']; ?>%</a>
                                    </div>
                                </div>
                                <div class="raise-funds">
                                    <div class="raise-money">
                                    <a class="raise-already btc-font-family raise-completed">BTC&nbsp;<?php echo !empty($vo['btc_ed'])?$vo['btc_ed']:0; ?></a><span class="raise-text"> 已筹金额</span>
                                    </div>
                                    <div class="raise-progress">
                                    <div class="meter">
                                    <span class="current-percent full-span raise-bg  " data-number="100" style="width:100%"></span>
                                    ...
                                    <a class="progress-percent raise-completed "><?php echo $vo['nbb']; ?>%</a>                            
                                    </div>
                                </div>
                                <div class="raise-funds">
                                    <div class="raise-money">
                                    <a class="raise-already btc-font-family raise-completed">LTC&nbsp;<?php echo !empty($vo['ltc_ed'])?$vo['ltc_ed']:0; ?></a><span class="raise-text"> 已筹金额</span>
                                    </div>
                                    <div class="raise-progress">
                                    <div class="meter">
                                    <span class="current-percent full-span raise-bg  " data-number="100" style="width:100%"></span>
                                    </div>
                                    <a class="progress-percent raise-completed "><?php echo $vo['ncc']; ?>%</a>
                                    </div>
                                </div>
                                <ul class="raise-info clearfix">
                                    <li class="right-bar">
                                    <a class="raise-info-val"><?php echo $vo['eth_target']; ?> ETH</a>
                                    <span>目标金额</span>
                                    </li>
                                    <li class="right-bar">
                                    <a class="raise-info-val"><?php echo $vo['btc_target']; ?> BTC</a>
                                    <span>目标金额</span>
                                    </li>
                                    <li class="right-bar">
                                    <a class="raise-info-val"><?php echo $vo['ltc_target']; ?> LTC</a>
                                    <span>目标金额</span>
                                    </li>
                                    <li class="right-bar pl20">
                                    <a class="raise-info-val"><?php echo !empty($vo['ico_days']) && $vo['ico_days']<0?0:$vo['ico_days']; ?></a>
                                    <span>剩余天数</span>
                                    </li>
<!--                                     <li class="pl20">
                                    <a class="raise-info-val">2,955</a>
                                    <span>支持者</span>
                                    </li> -->
                                </ul>
                                    <div class="raise-originator clearfix">
                                    <div class="originator-info">&nbsp;
                                    </div>
                                    <div class="investment-btn">
                                    <a href="javascript:;">
                                    <button data-id="<?php echo $vo['id']; ?>" onclick="javascript:location.href='/home/project/finish/id/<?php echo $vo['id']; ?>'" class="myZC">我要支持<svg width="6px" height="9px" viewBox="0 0 9 14">
...
<script>
    const myconfirm = layer.confirm;
    layer.confirm = function(str){
        if(str == '您确定要取消关注？'){
            return false;
        }else{
            myconfirm(str);
