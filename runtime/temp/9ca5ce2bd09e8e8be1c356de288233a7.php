<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/18ico.ewtouch.com/public/../application/admin/view/project/detail.html";i:1504751880;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form  class="form-horizontal m-t" id="commentForm"  method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="name" required="" aria-required="true" value="<?php echo $data['name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
...
<!--                         <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="name" required="" aria-required="true" value="<?php echo $data['users']['truename']; ?>--<?php echo $data['users']['phone']; ?>"> 
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control" name="fanic_status" required="" aria-required="true" id="fanic_status">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control" name="offical_address" required="" aria-required="true" id="offical_address">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="eth_target" type="text" class="form-control" name="eth_target" required="" aria-required="true" value="<?php echo $data['eth_target']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">目标BTC:</label>
                            <div class="input-group col-sm-4">
                                <input id="btc_target" type="text" class="form-control" name="btc_target" required="" aria-required="true" value="<?php echo $data['btc_target']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="ltc_target" type="text" class="form-control" name="ltc_target" required="" aria-required="true" value="<?php echo $data['ltc_target']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="eth_limit" type="text" class="form-control" name="eth_limit" required="" aria-required="true" value="<?php echo $data['eth_limit']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">BTC限额:</label>
                            <div class="input-group col-sm-4">
                                <input id="btc_limit" type="text" class="form-control" name="btc_limit" required="" aria-required="true" value="<?php echo $data['btc_limit']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="ltc_limit" type="text" class="form-control" name="ltc_limit" required="" aria-required="true" value="<?php echo $data['ltc_limit']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <textarea id="remark" type="text" class="form-control" name="remark" required="" aria-required="true" ><?php echo $data['remark']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="video" type="text" class="form-control" name="video" required="" aria-required="true" value="<?php echo $data['video']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="return_instr" type="text" class="form-control" name="return_instr" required="" aria-required="true" value="<?php echo $data['return_instr']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="return_time" type="number" class="form-control" name="return_time" required="" aria-required="true" value="<?php echo $data['return_time']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="linkman" type="text" class="form-control" name="linkman" required="" aria-required="true" value="<?php echo $data['linkman']; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="link_job" type="text" class="form-control" name="link_job" required="" aria-required="true" value="<?php echo $data['link_job']; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="link_phone" type="number" class="form-control" name="link_phone" required="" aria-required="true" value="<?php echo $data['link_phone']; ?>"  >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="ico_days" type="number" class="form-control" name="ico_days" required="" aria-required="true" value="<?php echo $data['ico_days']; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="start_times" name="start_times" value="<?php echo $data['start_times']; ?>">
                                <span class="input-group-addon">到</span>
                                <input type="text" class="form-control" id="end_time" name="end_time" value="<?php echo $data['end_time']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
