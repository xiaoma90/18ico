<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/www/wwwroot/18ico.ewtouch.com/public/../application/admin/view/data/index.html";i:1504751878;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox-content">
                ...
                <table class="table table-bordered">
                    ...
                    <?php if(!empty($tables)): if(is_array($tables) || $tables instanceof \think\Collection || $tables instanceof \think\Paginator): if( count($tables)==0 ) : echo "" ;else: foreach($tables as $key=>$vo): ?>
                        <tr>
                            <td><?php echo $vo['Tables_in_sql']; ?></td>
