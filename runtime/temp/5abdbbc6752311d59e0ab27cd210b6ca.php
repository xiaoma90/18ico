            ...
            <div class="user-body-right">
                <div id="capital_wrap">
                    <div class="capital-header">
                        <span class="capital-account">账户余额：<span class="btc-font-family">BTC：<?php echo $user['btc_acc']; ?></span>&nbsp;&nbsp;&nbsp;<span class="btc-font-family">ETH：<?php echo $user['eth_acc']; ?></span>&nbsp;&nbsp;&nbsp;<span class="btc-font-family">LTC：<?php echo $user['ltc_acc']; ?></span></span>
                    </div>
                    <div class="capital-body">
                        <table class="table">
                            ...
                            <tbody class="capital-tbody">
                            <?php foreach($data as $v): ?>
                            <tr>
                            <td><?php echo date('Y-m-d H:i',($v['created_at'])); ?></td>
                            <td><?php if($v['type']==1): ?>消费<?php else: ?>系统充值<?php endif; ?></td>
                            <td>BTC：<?php echo $v['btc_money']; ?><br/>LTC：<?php echo $v['ltc_money']; ?><br/>ETH：<?php echo $v['eth_money']; ?></td>
                            <!-- <td>状态</td> -->
                            <td class="text-center">BTC：<?php echo $user['btc_acc']; ?><br/>LTC：<?php echo $user['ltc_acc']; ?><br/>ETH：<?php echo $user['eth_acc']; ?></td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
                        <div class="capital-footer">
                            <div class="page-count"><span><?php echo $num; ?>条记录 </span><span>1/1页</span></div>
                            <div id="capital_page"></div>
                        </div>
                    </div>
                </div>
            </div>
