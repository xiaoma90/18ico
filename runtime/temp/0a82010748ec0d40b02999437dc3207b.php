<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/18ico.ewtouch.com/public/../application/admin/view/type/edit.html";i:1504831649;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" method="post" enctype="multipart/form-data" action="<?php echo url('type/do_insert'); ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control" name="type" id="link_account">
                                    <option value="1" <?php if($data['type'] ==1){echo 'selected';}?>>新闻</option>
                                    <option value="2" <?php if($data['type'] ==2){echo 'selected';}?>>公告</option>                                                                         
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" required=""
                                       aria-required="true" value="<?php echo $data['title']; ?>">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-sm-3 control-label">副标题：</label>
                            <div class="input-group col-sm-4">
                                <input id="auther" type="text" class="form-control" name="name" required="" aria-required="true" value="<?php echo $data['name']; ?>" />                              
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标签：</label>
                            <div class="input-group col-sm-4">
                                <input id="auther" type="text" class="form-control" name="labels" required="" aria-required="true" value="<?php echo $data['labels']; ?>"/>
                        ...
                        <div class="form-group draggable ui-draggable">
                            ...
                            <div class="col-sm-4">
                                <label class="checkbox-inline"><input value="1"  name="top" type="checkbox" <?php if($data['top'] ==1) echo 'checked';?>>置顶</label>                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">阅读量：</label>
                            <div class="input-group col-sm-4">
                                <input id="quantity" type="text" class="form-control" name="quantity" required="" aria-required="true" value="<?php echo $data['quantity']; ?>"/>                             
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">内容：</label>
                            <div class="col-sm-12">
                                <textarea id="myEditor" type="text" class="form-control myEditor" name="content" style="height:500px;"><?php echo $data['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
